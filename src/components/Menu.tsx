...
const Menu: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'bunny-chows', label: 'Bunny Chows', icon: Sandwich },
    { id: 'roti-rolls', label: 'Roti Rolls', icon: ChefHat },
  ...
  { id: 'roti-roll-chicken', name: 'Beans Roti Roll', description: 'Beans curry wrapped in roti bread.', price: 80, category: 'roti-rolls', isVegetarian: false },
...
Order Type: ${customerDetails.orderType === 'delivery' ? '🚚 Delivery (Delivery charges extra)' : '🏪 Takeaway'}
